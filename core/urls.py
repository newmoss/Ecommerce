...
#Views
from .views import home, stock, producto, tiendas, crearProducto, crearTienda, crearUsuario, menu, motivo, eliminar, pendiente, modificar_producto, registrar_producto, registrar_tienda, registrar_stock, modificar, registrar_usuario
